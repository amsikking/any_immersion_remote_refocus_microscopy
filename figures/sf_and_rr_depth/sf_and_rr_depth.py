...
# Standard focus depth:
def sf_depth(na, n_i, wd_mm, n_s, lambda_um):
...
# Combined depth:
def combined_depth(m, na, n_i, wd_mm, n_s, lambda_um):
    z_sf_max_um = sf_depth(na, n_i, wd_mm, n_s, lambda_um)
    z_rr_max_um = rr_depth(m, na, n_s, lambda_um)
...
# Highest NA:
N040x_air = combined_depth( 40, 0.95, 1.00, 0.210, n_s, lambda_um)
N060x_wat = combined_depth( 60, 1.27, 1.33, 0.180, n_s, lambda_um)
N100x_sil = combined_depth(100, 1.35, 1.41, 0.310, n_s, lambda_um)
N100x_oil = combined_depth(100, 1.45, 1.51, 0.130, n_s, lambda_um)

# Most pixels:
N020x_air = combined_depth( 20, 0.80, 1.00, 0.800, n_s, lambda_um)
N020x_wat = combined_depth( 20, 0.95, 1.33, 0.990, n_s, lambda_um)
N025x_sil = combined_depth( 25, 1.05, 1.41, 0.550, n_s, lambda_um)
N040x_oil = combined_depth( 40, 1.30, 1.51, 0.240, n_s, lambda_um)
...
y_limits = (0, 400)
# standard:
title = ('Standard focus depth (%inm)\n'%lambda_nm)
obj_data = (N040x_air[0], N060x_wat[0], N100x_sil[0], N100x_oil[0])
filename = 'sf_depth_highest_na.png'
plot(title, obj_name, obj_data, y_limits, filename)
title = ('Standard focus depth (%inm, log scale)\n'%lambda_nm)
filename = 'sf_depth_highest_na_log.png'
plot(title, obj_name, obj_data, y_limits, filename, log=True)
# combined:
title = ('Standard focus and remote refocus depth (%inm)\n'%lambda_nm)
obj_data = (N040x_air[1], N060x_wat[1], N100x_sil[1], N100x_oil[1])
filename = 'sf_and_rr_depth_highest_na.png'
plot(title, obj_name, obj_data, y_limits, filename)
title = ('Standard focus and remote refocus depth (%inm, log scale)\n'%
         lambda_nm)
filename = 'sf_and_rr_depth_highest_na_log.png'
plot(title, obj_name, obj_data, y_limits, filename, log=True)
...
filename = 'sf_depth_most_pixels.png'
plot(title, obj_name, obj_data, y_limits, filename)
title = ('Standard focus depth (%inm, log scale)\n'%lambda_nm)
filename = 'sf_depth_most_pixels_log.png'
plot(title, obj_name, obj_data, y_limits, filename, log=True)
# combined:
title = ('Standard focus and remote refocus depth (%inm)\n'%lambda_nm)
obj_data = (N020x_air[1], N020x_wat[1], N025x_sil[1], N040x_oil[1])
filename = 'sf_and_rr_depth_most_pixels.png'
plot(title, obj_name, obj_data, y_limits, filename)
title = ('Standard focus and remote refocus depth:(%inm, log scale)\n'%
         lambda_nm)
filename = 'sf_and_rr_depth_most_pixels_log.png'
plot(title, obj_name, obj_data, y_limits, filename, log=True)
